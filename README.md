...
- [ ] 사용자에게 몇 번의 이동을 할 것인지에 대한 입력을 받는다.
...
- [ ] 자동차 이름 입력
  - [ ] 자동차 이름 입력을 받으면 쉼표(,) 기준으로 자동차들을 분리한다.

- [ ] 전진하기
  - [ ] 각 자동차 별로 전진하는 유무를 생성한다.
    - [ ] 전진하는 조건은 0에서 9 사이에서 무작위 값을 구한 후 무작위 값이 4 이상일 경우이다.

### 출력

- [ ] 사용자에게 실행 결과와 함께 자동차의 이름과 전진 거리를 출력 한다.

  - [ ] 출력 메시지: `실행 결과`
  - [ ] 전진하는 자동차를 출력할 때 자동차 이름을 같이 출력한다.

- [ ] 사용자에게 누가 우승했는지를 알려준다.
  - [ ] 출력 메시지: `최종 우승자 : `
  - [ ] 우승자는 한 명 이상일 수 있다.
...
- 자동차 이름 입력
  ...
  - [ ] 빈 값으로 입력한 경우 다시 입력 받기
  - [ ] 숫자로 입력한 경우 다시 입력 받기
  - [ ] 5자 이상 이름을 입력한 경우 다시 입력 받기
  - [ ] 중복된 이름인 경우 다시 입력 받기

- 경기 횟수 입력
  - [ ] 빈 값으로 입력한 경우 다시 입력 받기
  - [ ] 숫자가 아닌 경우 입력한 경우 다시 입력 받기
...
- [ ] 프로그램 종료 시 `process.e it()`를 호출하지 않는다.
